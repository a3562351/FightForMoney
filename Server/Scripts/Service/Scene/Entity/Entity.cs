...
class Entity
{
    ...
    {
        return Server.GetInstance().GetService<SceneService>().GetSceneMgr().GetScene(this.scene_idx);
    }
    ...
    {
        Scene scene = Server.GetInstance().GetService<SceneService>().GetSceneMgr().GetScene(this.scene_idx);
        if (scene != null)
        {
